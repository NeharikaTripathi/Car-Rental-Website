    ...
    <div className='px-4 py-10 md:px-10 flex-1'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
        ...
        <div className='flex flex-col w-full'>
            ...
            className='px-3 py-2 mt-1 border border-borderColor rounded-md 
            outline-none' value={car.pricePerDay} 
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
        ...
        <div className='flex flex-col w-full'>
            ...
            value={car.transmission} className='px-2 py-2 mt-1 border border-borderColor rounded-md outline-none'>
      ...
      <div className='flex flex-col w-full'>
        <label>Location</label>
            ...
            value={car.location} className='px-8 py-2 mt-1 border border-borderColor rounded-md outline-none'>
      ...
      <div className='flex flex-col w-full'>
            ...
            <textarea rows={5} placeholder="e.g. A luxurious SUV with a spacious interior and powerfull engine."
            required className='px-3 py-2 mt-1 border border-borderColor rounded-md 
            outline-none' value={car.description} 
            onChange={e=> setCar({...car, description: e.target.value})}></textarea>
      </div>

      <button className='flex items-center ap-2 px-4 py-2.5 mt-4 bg-primary 
