    ...
    <div className='px-4 pt-10 md:px-10 flex-1'>
        ...
        max-w-3xl'>
            {dashboardCards.map((card, index)=>(
                <div key={index} className='flex gap-2 items-center justify-between
                 p-4 rounded-md border border-borderColor'>
                    ...
                    {/* Icon */}
                    <div className='flex items-center justify-center w-18 h-10 rounded-full
                    bg-primary/10'>
         ...
         <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
            ...
            w-full'>
                <h1 className='text-lg font-bold'>Recent Bookings</h1>
            ...
            {/* monthly revenue */}
            <div className='p-4 md:p-6 mb-6 border border-borderColor 
            rounded-md w-full md:max-w-xs'>
                <h1 className='text-lg font-bold'>Monthly Revenue</h1>
