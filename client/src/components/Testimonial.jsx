 ...
 const Testimonial = () => {
    ...
    const testimonials = [
        ...
        { name: "Ava Johnson", 
          ...
          image: assets.testimonial_image_1,  
          testimonial: "I highly recommend CarRental! Their fleet is amazing, and I always feel like I'm getting the best deal with excellent services"
        }
    ];
        ...
        travelers choose StayVenture for their luxury accomodations around the world"/>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-18">
                {testimonials.map((testimonial, index) => (
                    ...
                    viewport={{onces:true, amount: 0.3}}
