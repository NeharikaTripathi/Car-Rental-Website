...
const Hero = () => {
  ...
  return (
    ...
    className='h-screen flex flex-col items-center justify-center gap-14 bf-light text-center'>

        <motion.h1 initial={{y: 50, opacity: 0}}
            animate={{y: 0, opacity: 1}}
            transition={{duration: 0.8, delay: 0.2}}
        className='text-4xl md:text-5xl font-semibold'>
            Luxury cars on Rent</motion.h1>
        ...
        big-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
