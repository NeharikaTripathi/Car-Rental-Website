    ...
    try {
        ...
        var optimizedImageUrl = imagekit.url({
            ...
            transformation : [
                ...
                {format: 'webp'} //convert to modeern format
...
export const getDashboardData = async(req, res) =>{
    try {
        ...
        const pendingBookings = await Booking.find({owner: _id, status:
        "pending"})
        const completedBookings = await Booking.find({owner: _id, status:
        "confirmed"})
